...
export default async function SinglePostPage({ params }: PostPageProps) {
  ...
  // Posts relacionados da mesma categoria ou recentes
  const relatedPosts = BLOG_POSTS.filter((p) => p.id !== post.id).slice(0, 3);

  const whatsappMessage = encodeURIComponent(
    `Olá! Estava lendo o artigo "${post.title}" no Blog da JM MASTER GROUP e gostaria de tirar algumas dúvidas sobre as soluções.`
  );
      ...
      <article className="pt-28 sm:pt-36 md:pt-40 pb-16 sm:pb-24">
        ...
        <div className="w-full px-4 sm:px-6 md:px-12 lg:px-16 max-w-[1000px] mx-auto relative z-10 space-y-8 sm:space-y-12">
          ...
          {/* ========================================================
             ...
             ======================================================== */}
          <div className="prose prose-slate prose-lg max-w-none space-y-6 text-slate-700 leading-relaxed font-normal">
