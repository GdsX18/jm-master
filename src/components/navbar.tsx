    ...
    <header className="fixed top-2 sm:top-4 inset-x-0 z-50 px-3 sm:px-6 md:px-8 lg:px-12 max-w-[1440px] mx-auto pointer-events-none">
      ...
      >
        ...
        <Magnetic intensity={0.2}>
          <Link href="/" className="flex items-center group py-0.5" aria-label="JM Master Group Home">
        ...
        <div className="hidden lg:flex items-center space-x-1 bg-slate-900/5 p-1.5 rounded-full border border-slate-900/5 backdrop-blur-md">
          {NAV_LINKS.map((link) => {
            const isActive = link.href === "/blog" ? isBlog : false;
        ...
        <button
          ...
          className="lg:hidden p-2 rounded-xl bg-slate-900/5 border border-slate-900/10 text-slate-800 hover:text-[#E64F14] active:scale-95 transition-all focus:outline-none flex items-center justify-center cursor-pointer"
